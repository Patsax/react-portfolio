        ...
        <section className="my-5 main">
            ...
            <div className="bio">
                ...
                <div>
                    ...
                    <p>In my spare time I pursue several forms of entertainment. I like most forms of gaming be they video, board, or even card games. I quite like to read with fantasy and sci-fi being my favorite genres. I also enjoy watching movies such as anything Star Wars, Star Trek (the two are not mutually exclusive), Marvel, etc. You might call me a huge nerd. 😊</p>
                </div>
            </div>
        </section>
    );
